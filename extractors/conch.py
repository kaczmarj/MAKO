    ...
    for wsi_path, patch_path in tqdm(
        ...
        for batch in tqdm(loader, leave=False, desc="Patches"):
            ...
            with torch.inference_mode():
                # The args proj_contrast and normalize have the same value.
                embedding = model.encode_image(
                    batch,
                    proj_contrast=proj_contrast,
                    normalize=proj_contrast,
                )
...
if __name__ == "__main__":
    ...
    p.add_argument(
        "--proj-contrast",
        action="store_true",
        help="Use this if using language in addition to images.",
    )
    args = p.parse_args()
    ...
    main(
        ...
        proj_contrast=args.proj_contrast,
